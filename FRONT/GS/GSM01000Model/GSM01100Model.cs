...
namespace GSM01000Model
{
    public class GSM01100Model: R_BusinessObjectServiceClientBase<GSM01100DTO>, IGSM01100
    {
        ...
        public async Task<GSM01100UserListDTO> GetAllCoAUserAsync(string pcCGLACCOUNT_NO)
        {
        ...
        public async Task<List<AssignUserDTO>> GetUserToAssignListAsync(string pcCGLACCOUNT_NO)
        {
            var loEx = new R_Exception();
