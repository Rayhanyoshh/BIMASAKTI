...
namespace PMR00160FRONT
{
    public partial class PMR00160 : R_Page
    {
        private PMR00160ViewModel _viewModel = new();
        ...
        private async Task OnPrint()
        {
            ...
            try
            {
                DateTime DFROM_PERIOD = DateTime.ParseExact(_viewModel.lnPeriodYearFrom + _viewModel.lcPeriodMonthFrom, "yyyyMM", CultureInfo.InvariantCulture);
                DateTime DTO_PERIOD = DateTime.ParseExact(_viewModel.lnPeriodYearTo + _viewModel.lcPeriodMonthTo, "yyyyMM", CultureInfo.InvariantCulture);
                ...
                PMR00160DBParamDTO param = new PMR00160DBParamDTO()
                {
                    ...
                    DFROM_PERIOD = DateTime.ParseExact(_viewModel.lnPeriodYearFrom + _viewModel.lcPeriodMonthFrom, "yyyyMM", CultureInfo.InvariantCulture),
                    DTO_PERIOD = DateTime.ParseExact(_viewModel.lnPeriodYearTo + _viewModel.lcPeriodMonthTo, "yyyyMM", CultureInfo.InvariantCulture),
                    CFROM_PERIOD_DISPLAY = DFROM_PERIOD.ToString("MM/yyyy"),
                    CTO_PERIOD_DISPLAY = DTO_PERIOD.ToString("MM/yyyy"),
                };
                ...
                if (param.CREPORT_TYPE == "1") //SUMMARY
                {
                  ...
                  "PM",
                  "rpt/PMR00160SummaryReport/SummaryReportPost",
                  "rpt/PMR00160SummaryReport/SummaryReportGet",
                  param);
                }
                else if (param.CREPORT_TYPE == "2") //DETAIL
                {
                  ...
                  "R_DefaultServiceUrlPM",
                  "PM",
                   "rpt/PMR00160DetailReport/DetailReportPost",
                  "rpt/PMR00160DetailReport/DetailReportGet",
                  param);
                }
