...
public partial class PMM05001 : R_Page,R_ITabPage
{
    private PMM05000ViewModel _viewModelPricing = new();

        private R_Conductor _conUnitTypeCTG;
        private R_Grid<UnitTypeCategoryDTO> _gridOtherUnit;
        ...
        private async Task NextPricingDate_ServiceGetListRecord(R_ServiceGetListRecordEventArgs eventArgs)
        {
            ...
            try
            {
                await _viewModelPricing.GetPricingList(PMM05000ViewModel.eListPricingParamType.GetNext, true);
        ...
        private async Task NextPricing_ServiceGetListRecord(R_ServiceGetListRecordEventArgs eventArgs)
        {
            ...
            try
            {
                await _viewModelPricing.GetPricingList(PMM05000ViewModel.eListPricingParamType.GetNext, false);
        ...
        private void BeforeOpenPopup_AddNextPricing(R_BeforeOpenPopupEventArgs eventArgs)
        {
            ...
            eventArgs.TargetPageType = typeof(PMM05001PopupAdd);
        }
