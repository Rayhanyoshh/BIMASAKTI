...
namespace GSM05000Model
{
    public class GSM05000Model : R_BusinessObjectServiceClientBase<GSM05000DTO>, IGSM05000
    {
        ...
        public GSM05000ListDTO<GSM05000DelimeterDTO> GetDelimiterList()
        {
            throw new NotImplementedException();
        }
        ...
        public async Task<GSM05000ListDTO<GSM05000DelimeterDTO>> GetDelimiterAsync()
        {
            var loEx = new R_Exception();
            GSM05000ListDTO<GSM05000DelimeterDTO> loResult = null;

            try
            {
                R_HTTPClientWrapper.httpClientName = DEFAULT_HTTP_NAME;
                loResult = await R_HTTPClientWrapper.R_APIRequestObject<GSM05000ListDTO<GSM05000DelimeterDTO>>(
                    _RequestServiceEndPoint,
