...
public class PMR02105DetailDummyData
{
                ...
                for (int c = 1; c < Data3; c++)
                {
                    for (int d = 1; d < Data4; d++)
                    {
                        loCollection.Add(new PMR02100DTO()
                        {
                            ...
                            CCUSTOMER_ID = $"MU0{a}",
                            CCUSTOMER_NAME = $"Muhammad Andika Putra{a}",
                            ...
                            CUNIT_DESCRIPTION = $"PT. Pasti Bisa{b}",
                            CAGREEMENT_NO = $"AGREE-REF-0{b}",
                            CINVOICE_NO = $"INV-REF-01-0{c}",
                            CINVGRP_DUE_DATE = $"13-Jan-202{c}",
                            CINVGRP_CODE = $"SC{c}",
                            CINVGRP_NAME = $"Service Charge{c}",
