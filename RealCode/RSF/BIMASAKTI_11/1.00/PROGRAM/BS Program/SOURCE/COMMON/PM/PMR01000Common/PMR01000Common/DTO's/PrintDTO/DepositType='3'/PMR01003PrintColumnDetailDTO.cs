...
public class PMR01003PrintColumnDetailDTO
{
    ...
    public string COLOUMN_DETAIL_AMOUNT { get; set; } = "Amount";
    public string COLOUMN_DETAIL_DEPOSIT_BALANCE { get; set; } = "Deposit Balance";
}