...
public class PMR02108PrintController : R_ReportControllerBase
{
    ...
    public PMR02108PrintController(ILogger<LoggerPMR02100Print> logger)
    {
    ...
    {
        pcFileTemplate = System.IO.Path.Combine("Reports", "PMR02104Detail.frx");
    }
