...
public class PMR02107PrintController : R_ReportControllerBase
{
    ...
    public PMR02107PrintController(ILogger<LoggerPMR02100Print> logger)
    {
    ...
    {
        pcFileTemplate = System.IO.Path.Combine("Reports", "PMR02103Detail.frx");
    }
