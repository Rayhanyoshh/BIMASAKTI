...
public class PMR02112PrintController : R_ReportControllerBase
{
    ...
    public PMR02112PrintController(ILogger<LoggerPMR02100Print> logger)
    {
    ...
    {
        pcFileTemplate = System.IO.Path.Combine("Reports", "PMR02108Detail.frx");
    }
