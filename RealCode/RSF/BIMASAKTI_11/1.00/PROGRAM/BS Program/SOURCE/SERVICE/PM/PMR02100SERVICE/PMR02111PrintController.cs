...
public class PMR02111PrintController : R_ReportControllerBase
{
    ...
    public PMR02111PrintController(ILogger<LoggerPMR02100Print> logger)
    {
    ...
    {
        pcFileTemplate = System.IO.Path.Combine("Reports", "PMR02107Detail.frx");
    }
