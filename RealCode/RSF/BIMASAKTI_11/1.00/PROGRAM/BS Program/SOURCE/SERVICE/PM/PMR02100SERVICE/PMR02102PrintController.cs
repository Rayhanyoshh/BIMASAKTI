...
public class PMR02102PrintController : R_ReportControllerBase
{
    ...
    public PMR02102PrintController(ILogger<LoggerPMR02100Print> logger)
    {
    ...
    {
        pcFileTemplate = System.IO.Path.Combine("Reports", "PMR02102Summary.frx");
    }
