...
public class PMR02110PrintController : R_ReportControllerBase
{
    ...
    public PMR02110PrintController(ILogger<LoggerPMR02100Print> logger)
    {
    ...
    {
        pcFileTemplate = System.IO.Path.Combine("Reports", "PMR02106Detail.frx");
    }
