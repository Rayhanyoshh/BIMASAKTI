...
public class PMR02105PrintController : R_ReportControllerBase
{
    ...
    public PMR02105PrintController(ILogger<LoggerPMR02100Print> logger)
    {
    ...
    {
        pcFileTemplate = System.IO.Path.Combine("Reports", "PMR02101Detail.frx");
    }
