...
public class PMR02104PrintController : R_ReportControllerBase
{
    ...
    public PMR02104PrintController(ILogger<LoggerPMR02100Print> logger)
    {
    ...
    {
        pcFileTemplate = System.IO.Path.Combine("Reports", "PMR02104Summary.frx");
    }
