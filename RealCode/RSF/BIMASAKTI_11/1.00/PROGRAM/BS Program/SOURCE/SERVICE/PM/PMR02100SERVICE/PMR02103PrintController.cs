...
public class PMR02103PrintController : R_ReportControllerBase
{
    ...
    public PMR02103PrintController(ILogger<LoggerPMR02100Print> logger)
    {
    ...
    {
        pcFileTemplate = System.IO.Path.Combine("Reports", "PMR02103Summary.frx");
    }
