...
public class PMR02109PrintController : R_ReportControllerBase
{
    ...
    public PMR02109PrintController(ILogger<LoggerPMR02100Print> logger)
    {
        LoggerPMR02100Print.R_InitializeLogger(logger);
        _logger = LoggerPMR02100Print.R_GetInstanceLogger();
        _activitySource = PMR02100Activity.R_InitializeAndGetActivitySource(nameof(PMR02109PrintController));
    ...
    {
        pcFileTemplate = System.IO.Path.Combine("Reports", "PMR02105Detail.frx");
    }
    ...
    private PMR02100DetailPrintResultWithBaseHeaderPrintDTO GenerateDataPrint(PMR02100PrintParamDTO poParam)
    {
        ...
        try
        {
            ...
            loData.DataResult = loCollection.Count > 0 ? loCollection : null;
