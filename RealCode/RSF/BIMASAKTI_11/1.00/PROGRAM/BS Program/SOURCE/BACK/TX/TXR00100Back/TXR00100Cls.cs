...
namespace TXR00100Back;

public class TXR00100Cls
{
    ...
    public TXR00100Cls()
    {
        ...
        _activitySource = TXR00100Activity.R_GetInstanceActivitySource();
    }

    public List<TXR00100DataResultDTO> GetPrintDataResult (PrintParamTXDTO poEntity)
    {
       using Activity activity = _activitySource.StartActivity("GetPrintDataResultGOA");

       R_Exception loEx = new R_Exception();
       List<TXR00100DataResultDTO> loResult = null;
       ...
       try
       {
           ...
           var lcQuery = "RSP_TXR00100_WHTAX_SLIP_REPORT";
           ...
           loDb.R_AddCommandParameter(loCmd, "@CWH_TAX_TYPE", DbType.String, 50, poEntity.CWH_TAX_TYPE);
           loDb.R_AddCommandParameter(loCmd, "@CSORT_BY", DbType.String, 50, poEntity.CSORT_BY);
           ...
           loResult = R_Utility.R_ConvertTo<TXR00100DataResultDTO>(loDataTable).ToList();
       }
       catch (Exception ex)
       {
           // Log the exception
    ...
    public List<TXR00100PeriodDetailDTO> PeriodDetailListDB (PrintParamTXDTO poEntity)
    {
        R_Exception loException = new R_Exception();
        List<TXR00100PeriodDetailDTO> loResult = null;
        try
        {
            var loDb = new R_Db();
            ...
            var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);
            loResult = R_Utility.R_ConvertTo<TXR00100PeriodDetailDTO>(loDataTable).ToList();
        }
        catch (Exception ex)
        {
            loException.Add(ex);
