...
namespace CBT01200BACK
{
    public class CBT01210Cls
    {
        ...
        public CBT01210DTO GetJournalDisplay(CBT01210DTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity(MethodBase.GetCurrentMethod().Name);
            var loEx = new R_Exception();
            CBT01210DTO loResult = null;
            ...
            try
            {
                ...
                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);
                loResult = R_Utility.R_ConvertTo<CBT01210DTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        public CBT01210DTO SaveJournal(CBT01210DTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity(MethodBase.GetCurrentMethod().Name);
            var loEx = new R_Exception();
            string lcQuery = "";
        ...
        public CBT01210DTO SaveJournalDetail(CBT01211DTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity(MethodBase.GetCurrentMethod().Name);
            var loEx = new R_Exception();
            CBT01210DTO loResult = null;
