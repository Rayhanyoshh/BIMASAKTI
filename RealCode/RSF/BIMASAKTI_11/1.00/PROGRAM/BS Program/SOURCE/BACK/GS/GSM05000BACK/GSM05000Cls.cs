...
public class GSM05000Cls : R_BusinessObject<GSM05000DTO>
{
    ...
    public List<GSM05000DelimeterDTO> GetDelimiterListDb(GSM05000ParameterDb poParameterDb)
    {
        R_Exception loEx = new();
        List<GSM05000DelimeterDTO> loRtn = null;
        R_Db loDb;
        DbConnection loConn;
        DbCommand loCmd;
        string lcQuery;
        try
        {
            ...
            loRtn = R_Utility.R_ConvertTo<GSM05000DelimeterDTO>(loDataTable).ToList();
        }
        catch (Exception ex)
        {
            loEx.Add(ex);
